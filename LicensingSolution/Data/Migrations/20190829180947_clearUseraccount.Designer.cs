...
namespace LicensingSolution.Data.Migrations
{
    ...
    [Migration("20190829180947_clearUseraccount")]
    partial class clearUseraccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LicensingSolution.Models.DrivingLicence", b =>
                {
                    ...
                    b.HasIndex("DriverIDNumber")
                        .IsUnique()
                        .HasFilter("[DriverIDNumber] IS NOT NULL");
            ...
            modelBuilder.Entity("LicensingSolution.Models.UserContact", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("UserContact");
                });
            ...
            modelBuilder.Entity("LicensingSolution.Models.DrivingLicence", b =>
                {
                    b.HasOne("LicensingSolution.Models.Driver", "Driver")
                        ...
                        .HasForeignKey("LicensingSolution.Models.DrivingLicence", "DriverIDNumber");
                });
